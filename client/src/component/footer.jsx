    ...
    return (
        <div>
            <>
                ...
                <footer className="bg-dark text-white text-center text-lg-start mt-auto py-3" style={{ backgroundColor: "#BB5A3A" }} >
                    ...
                    <div className="text-center p-3" style={{ backgroundColor: '#BB5A3A' }}>
